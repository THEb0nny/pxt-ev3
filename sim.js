...
(function (pxsim) {
    class EV3Board extends pxsim.CoreBoard {
        constructor() {
            ...
            this.bus.setNotify(10000 /* DEVICE_ID_NOTIFY */, 10001 /* DEVICE_ID_NOTIFY_ONE */);
        ...
        constructor() {
            ...
            pxsim.MMapMethods.register("/dev/lms_analog", {
                ...
                beforeMemRead: () => {
                    ...
                    for (let port = 0; port < 4 /* NUM_INPUTS */; port++) {
                        const node = inputNodes[port];
                        if (node) {
                            if (node.isAnalog())
                                data[AnalogOff.InDcm + port] = node.getDeviceType();
                            data[AnalogOff.InConn + port] = node.isUart() ? 122 /* CONN_INPUT_UART */ : (!node.isNXT() ? 121 /* CONN_INPUT_DUMB */ : 119 /* CONN_NXT_DUMB */);
...
(function (pxsim) {
    class EV3ButtonState extends pxsim.CommonButtonState {
        constructor() {
            super();
            this.buttons = [
                new pxsim.CommonButton(1 /* BUTTON_ID_UP */),
                new pxsim.CommonButton(2 /* BUTTON_ID_ENTER */),
                new pxsim.CommonButton(4 /* BUTTON_ID_DOWN */),
                new pxsim.CommonButton(8 /* BUTTON_ID_RIGHT */),
                new pxsim.CommonButton(16 /* BUTTON_ID_LEFT */),
                new pxsim.CommonButton(32 /* BUTTON_ID_ESCAPE */)
            ];
...
(function (pxsim) {
    ...
    (function (sensors) {
        function __sensorUsed(port, type) {
            ...
            if (type == 100 /* DEVICE_TYPE_IIC_UNKNOWN */)
                return; // Ignore IIC        
        ...
        updateStateStep(elapsed) {
            if (this.manualAngle === undefined) {
                ...
                switch (this.speedCmd) {
                    case 165 /* opOutputSpeed */:
                    case 164 /* opOutputPower */:
                        // assume power == speed
                        // TODO: PID
                        this.speed = this.speedCmdValues[0];
                        break;
                    case 175 /* opOutputTimeSpeed */:
                    case 173 /* opOutputTimePower */:
                    case 172 /* opOutputStepPower */:
                    case 174 /* opOutputStepSpeed */: {
                        ...
                        const isTimeCommand = this.speedCmd == 173 /* opOutputTimePower */ || this.speedCmd == 175 /* opOutputTimeSpeed */;
                    ...
                    case 176 /* opOutputStepSync */:
                    case 177 /* opOutputTimeSync */: {
                        ...
                        const dstep = this.speedCmd == 177 /* opOutputTimeSync */
                            ? pxsim.U.now() - this.speedCmdTime
                            : this.tacho - this.speedCmdTacho;
...
(function (pxsim) {
    ...
    class NXTLightSensorNode extends pxsim.AnalogSensorNode {
        ...
        getDeviceType() {
            return 2 /* DEVICE_TYPE_NXT_LIGHT */;
        }
        setValue(value) {
            this.value = value;
            this.setChangedState();
        ...
        constructor() {
            ...
            pxsim.MMapMethods.register("/dev/lms_pwm", {
                ...
                write: buf => {
                    ...
                    const cmd = buf.data[0];
                    switch (cmd) {
                        case 3 /* opProgramStart */: {
                            // init
                            return 2;
                        }
                        case 162 /* opOutputReset */: {
                            // reset
                            const port = buf.data[1];
                        ...
                        case 167 /* opOutputPolarity */: {
                            console.error("opOutputPolarity not supported");
                            return 2;
                        }
                        case 161 /* opOutputSetType */: {
                    ...
                    for (let port = 0; port < 4 /* NUM_INPUTS */; port++) {
                        ...
                        if (node && node.isUart()) {
                            ...
                            if (!node.isModeReturnArr()) {
                                ...
                                pxsim.util.map16Bit(data, UartOff.Raw + 32 /* MAX_DEVICE_DATALENGTH */ * 300 * port + 32 /* MAX_DEVICE_DATALENGTH */ * index, value);
                            }
                            else {
                                const values = node.getValues();
                                for (let i = 0, offset = 0; i < values.length; i++, offset += 2) {
                                    pxsim.util.map16Bit(data, UartOff.Raw + 32 /* MAX_DEVICE_DATALENGTH */ * 300 * port + 32 /* MAX_DEVICE_DATALENGTH */ * index + offset, Math.round(values[i]));
                                }
                            }
                            // Status
...
(function (pxsim) {
    class UltrasonicSensorNode extends pxsim.UartSensorNode {
        ...
        getDeviceType() {
            return 30 /* DEVICE_TYPE_ULTRASONIC */;
        }
    ...
    (function (visuals) {
        class TouchSensorView extends visuals.ModuleView {
            ...
            attachEvents() {
                ...
                const state = pxsim.ev3board().getSensor(this.port, 16 /* DEVICE_TYPE_TOUCH */);
                pxsim.pointerEvents.down.forEach(evid => btn.addEventListener(evid, ev => {
